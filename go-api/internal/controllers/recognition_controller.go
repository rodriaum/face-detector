...
import (
	"encoding/base64"
	"face-detector-api/internal/helpers"
	"face-detector-api/internal/services"
	"mime/multipart"
	"net/http"
	"path/filepath"
	"time"
...
func NewRecognitionController(mongoService *services.MongoService) *RecognitionController {
...
func (c *RecognitionController) UploadImage(ctx *gin.Context) {
...
func (c *RecognitionController) GetImage(ctx *gin.Context) {
	id := ctx.Param("id")
...
func (c *RecognitionController) DeleteImage(ctx *gin.Context) {
	id := ctx.Param("id")
